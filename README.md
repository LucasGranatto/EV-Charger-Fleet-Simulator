...
status/SoC/energia/corrente/fila offline ao vivo (atualiza a cada 1.5s)
e tem botões pra start/stop/pause/resume/fault/clear/disconnect/remover.
Chargers podem ser adicionados e removidos a qualquer momento, com o
processo já rodando.
